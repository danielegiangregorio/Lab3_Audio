set_property IOSTANDARD LVCMOS33 [get_ports {SPI_M_0_io0_io[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SPI_M_0_io1_io[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SPI_M_0_sck_io[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SPI_M_0_ss_io[0]}]
set_property PACKAGE_PIN J1 [get_ports {SPI_M_0_ss_io[0]}]
set_property PACKAGE_PIN G2 [get_ports {SPI_M_0_sck_io[0]}]
set_property PACKAGE_PIN J2 [get_ports {SPI_M_0_io1_io[0]}]
set_property PACKAGE_PIN L2 [get_ports {SPI_M_0_io0_io[0]}]
